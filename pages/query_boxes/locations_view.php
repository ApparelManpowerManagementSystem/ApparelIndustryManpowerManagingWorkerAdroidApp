                        ...
                        <div class='modal-dialog'>
                          <div class='modal-content' style='width: 70%'>
                            ...
                            <div class='modal-body'>
                                ...
                                <form action='./query_boxes/remove_location.php' autocomplete='on' method='post'>
                                    <div style='display:none' class='.d-none'>
                                        
                                        <input value='" . $rowLoc['locID'] . "' type='text' class='form-control hidden' name='jobID' required>
                                    </div>
