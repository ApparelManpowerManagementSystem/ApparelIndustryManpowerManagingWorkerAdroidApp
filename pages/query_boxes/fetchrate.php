...
foreach($result as $row)
{
 ...
 ';
    ...
    for($count=1; $count<=5; $count++)
    {
        ...
        $output .= '<li class="list-inline-item" title="'.$count.'" jobType="'.$row['jobType'].'-'.$count.'" data-index="'.$count.'"  data-job_id="'.$row['jobType'].'" data-rating="'.$rating.'" class="rating" style="cursor:pointer; '.$color.' font-size:16px;">&#9733;</li>';
    }
    $output .= '
 </ul>
 ';
